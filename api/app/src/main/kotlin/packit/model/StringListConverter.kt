 ...
 * a database array type directly to a Kotlin List. JPA does not support String[] as a basic attribute type. The
 * converter ensures that the data is correctly transformed when reading from and writing to the database.
 */
@Converter
